...
const uint8_t STM32F20x_STR[] = {"\r\n"\
           "  _____ _______ __  __ ____ ___  _____   _     ___\r\n"\
           " / ____|__   __|  \\/  |___ \\__ \\|  ___| //_   / _ \\\r\n"\
           "| (___    | |  | \\  / | __) | ) | |__  //| | | | | |_  __\r\n"\
           " \\___ \\   | |  | |\\/| ||__ < / /|  __|//_|_|_| | | \\ \\/ /\r\n"\
           " ____) |  | |  | |  | |___) / /_| |   \\__|_|_| |_| |>  <\r\n"\
...
void Printf_Init(void)
{
  ...
  */
  ...
  /*printf("\r\n\n\n\r ARMJISHU.COM神舟王STM32F407ZGT开发板 %s printf configured......", EVAL_COM1_STR);
  printf("\n\r ############ WWW.ARMJISHU.COM! ############ ("__DATE__ " - " __TIME__ ")");

  printf("%s", STM32F20x_STR);

  printf(" WWW.ARMJISHU.COM use __STM32F4XX_STDPERIPH_VERSION %d.%d.%d",

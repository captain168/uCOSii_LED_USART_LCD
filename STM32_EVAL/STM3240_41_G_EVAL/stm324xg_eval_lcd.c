...
{ 
 __IO uint32_t lcdid = 0;
  ...
  //DUG_PRINTF("\n\r 神舟王STM32407ZGT LCD_Init Configure the LCD ");
...
/* Configure the FSMC Parallel interface -------------------------------------*/
  ...
  LCD_Clear(LCD_COLOR_BLACK);       	    //初始化为黑色背景

  //LCD_DisplayWelcomeStr(LCD_LINE_0);      //初始化欢迎界面
  ...
  //DUG_PRINTF("\n\r ###### LCD_PIXEL_WIDTH  %d;  LCD_PIXEL_HEIGHT  %d. ###### \n\r", LCD_PIXEL_WIDTH, LCD_PIXEL_HEIGHT);
